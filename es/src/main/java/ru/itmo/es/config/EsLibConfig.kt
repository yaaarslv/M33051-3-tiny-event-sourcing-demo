 ...
 */
@Configuration
open class EsLibConfig {

    private val logger = LoggerFactory.getLogger(EsLibConfig::class.java)

    @Autowired
    private lateinit var subscriptionsManager: AggregateSubscriptionsManager

    @Autowired
    private lateinit var projectEventSubscriber: ProjectEventsSubscriber
